...
class FileIOOperations{
	...
	void saveDataInFile(String data) {
		try {
			...
			File file = new File("C:/users/vaibh/Downloads/customers.csv");
			//if(file.exists())
	...
	void serialization(Customer customer) {
		try {
			...
			File file = new File("C:/users/vaibh/Downloads/"+customer.name+".txt");
	...
	void deserialization(String phone) {
		try {
			...
			File file = new File("C:/users/vaibh/Downloads/"+phone+".txt");
